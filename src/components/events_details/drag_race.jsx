          ...
          <div className="bg-[#ffb4a7] px-[20px] md:px-[40px] py-[30px] rounded-[30px] text-center">
            ...
            <div className="mt-[10px]">
              <span className="font-semibold text-[18px]">
                All teams must consist of 2 participants each.
              </span>
            </div>
        ...
        <div>
              ...
              <div className="text-center mb-[50px]">
                ...
                <div className="mx-[20px] md:mx-[120px] xl:mx-[220px]">
                  <span className="text-[17px] font-semibold">
                    Welcome to the Drag Race! Participants will compete using provided robots in a thrilling drag racing challenge. The event is designed for fun and friendly competition, where everyone can showcase their skills in controlling the robots.
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="flex justify-center text-[17px] text-center font-semibold">
              <div>
                <ul className="list-disc list-inside">
                  <li><b>Heats:</b> The event will feature a single heat, with 2 participants racing at a time and the fastest times determining who advances.</li>
                  <li><b>Race Track:</b> The surface will be even and suitable for racing.</li>
                  <li><b>Timing:</b> Each race will last 6 minutes, and the fastest recorded time will be used for ranking.</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className={`${activeButton === 2 ? "active-div" : "deactive-div"} mx-[20px]`}>
            ...
            <div className="flex justify-center text-[17px] text-center font-semibold">
              <div>
                <ul className="list-disc list-inside">
                  <li><b>Speed:</b> The primary focus is on the fastest race time.</li>
                  <li><b>Control:</b> Smoothness and precision in controlling the robot will be noted for potential awards.</li>
                </ul>
                ...
                <ul className="list-disc list-inside">
                  ...
                  <li>Verbal or physical abuse towards participants or event staff.</li>
                </ul>
              </div>
            </div>
          </div>
