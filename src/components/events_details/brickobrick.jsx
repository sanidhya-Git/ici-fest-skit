      ...
      <div className='flex justify-center'>
        <div className=' mx-[10px] md:mx-[60px] lg:mx-[200px] w-full'>
          <div className='bg-[#ffb4a7] px-[20px] md:px-[40px] py-[30px] rounded-[30px] text-center'>
            ...
            <Link
              to={`https://erp.skit.ac.in/register/r/brick_o_brick`}
              target='_blank'
            >
            ...
            <div className='mt-[10px]'>
              <span>
                <b>
                  {' '}
                  For more details - Siddharth Lawaniya:{' '}
              ...
              <div className='text-center  mb-[50px]'>
                ...
                <div className='mx-[20px] md:mx-[120px] xl:mx-[220px] '>
                  <span className='text-[17px] font-semibold'>
                    ...
                    bricks, cement, and water. Focus on teamwork, creativity,
                    and mindfulness. Each team is encouraged to collaborate
                ...
                <div className='mx-[20px] md:mx-[120px] xl:mx-[220px] '>
                  <span className='text-[17px] font-semibold'>
                    1. Participants must have a team of 4 members.
                    <br />
                    2. Use of unfair means and getting help from others will
                    result in disqualification.
                    <br />
                    3. All the members of the team should be present on time of
                    commencement.
                    <br />
                    4. Limited quantity of cement and bricks will be provided.
                    <br />
                    5. We will not be responsible for any injuries caused during
                    the game.
                  </span>
                </div>
                <div className='flex justify-center'>
          ...
          >
            ...
            <div className=' flex justify-center text-[17px]'>
              <div>
                <div>
                  <span>
                    ● On the basis of appearance/geometry.
                    <br />
                    ● Placement of Bricks and its bond alignment.
                    <br />
                    ● 90° angle between the corners of wall.
                    <br />
                    ● Straightness of wall.
                    <br />● Space of each step must be same.
                  </span>
                </div>
                <div className='text-center mb-[10px]'>
                  <span className='font-bold text-[20px] underline'>
                ...
                <div>
                  <span>
                    1.Participant will be disqualified if they are found getting
                    external help.
                    <br />
                    2. Participants will be disqualified for late arrival.
                    <br />
                    3. Sabotaging other teams will lead in disqualification.
                  </span>
                </div>
              </div>
            </div>
